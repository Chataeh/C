/**
*파일이름"21812160_차태현_homework14 "
*프로그램의 목적 및 기본 기능:
*  멀티스레드를 이용하여 연결리스트큐에 있는이벤트들 처리.
*
*프로그램 작성자: 21812160 차태현(2021년 6월4일),
*최종 수정 및 보완: 2021년 6월 4일 (차태현)
*/
#include <stdio.h>
#include <stdlib.h>
#include <Windows.h>
...
int main()
{
	...
	{
		thrdMon.eventProcessed[ev].seqNO = -1; // mark as not-processed
		thrdMon.eventProcessed[ev].priority = -1;
	...
	for (int round = 0; round < MAX_ROUND; round++)
	{
		...
		printf("Event_Generators have generated total %2d events\n", thrdMon.totalEventGen);
		int totalEventGenerated = thrdMon.totalEventProc;
